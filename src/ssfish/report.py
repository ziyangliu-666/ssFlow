"""Markdown report renderer for ssFish OASIS-engine simulations.
...
def _render_header(result: "OasisSimResult") -> str:
    ...
    return f"""# ssFish Market Simulation Report

**Event**: `{instrument}` · {event.event_type} · {event.event_date}
**Simulation ID**: `{result.simulation_id}`
**Engine**: OASIS (camel-oasis) + ssFish trading layer
...
> Report generated by ssFish (Phase I — OASIS-based information ecosystem).
